...
#'        \item{\code{class}} {Character indicator of the movement classification assigned to the given burst. Primary classes include "Normal_Movement", "Quick_Cross", "Back_n_forth", "Bounce", "Trace", and "Unknown". Additional temporary indicators include "Normal_lclNA", "Unknown_insufficient_n", "Normal_sd0", and "Unknown_cross_bounce". These tier to the previous classifications but provide additional information about why that categorization was reached, for diagnostic purposes.}
